...
import 'user_profileeditpage.dart';
import 'widget/button_widget.dart';
import 'widget/profile_widget.dart';

class User_ProfilePage extends StatefulWidget {
  @override
  _User_ProfilePageState createState() => _User_ProfilePageState();
}
...
class _User_ProfilePageState extends State<User_ProfilePage> {
  ...
  Future<void> updateImage() async {
    ...
    try {
      final regBody = {"imagePath": userData.imgPath};
      final response =
          ...
          : ListView(
              ...
              children: [
                ...
                imgUploadStart
                    ...
                    : ProfileWidget(
                        imagePath: userData.imgPath, onClicked: selectPhoto),
                ...
                Center(
                  ...
                  onPressed: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const user_ProfileEditPage(),
                        )).then((value) {
                      setState(() {});
                    });
                  },
                ...
                itemProfile('Wallet balance', userData.walletbalance.toString(),
                    Icons.wallet),
                const SizedBox(height: 7),
                InkWell(
                  child: itemProfile('History', 'Click To watch history',
                ...
                // const SizedBox(height: 7),
                // itemProfile('Charges (RS./pm)', userData.chargespm.toString(),
  ...
  //               Text("${userData.disorders[index]['disorder_name']}, "),
  //           itemCount: min(userData.disorders.length, 5),
  //         ),
  //       ),
  //       leading: Icon(iconData),
  //       // trailing: Icon(Icons.arrow_forward, color: Colors.grey.shade400),
        ...
        children: [
          ...
          Text(
            ...
            style: GoogleFonts.lato().copyWith(
                color: const Color.fromARGB(255, 79, 79, 79), fontSize: 14.5),
          )
        ],
      );
