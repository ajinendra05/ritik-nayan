...
import './passwordResetPsyco.dart';
import './resetpassword.dart';
import 'package:pinput/pinput.dart';

class otpScreenPsyco extends StatefulWidget {
  final otpNum;
  final email;
  const otpScreenPsyco({Key? key, required this.otpNum, required this.email})
      : super(key: key);

  @override
  State<otpScreenPsyco> createState() => _otpScreenPsycoState();
}

class _otpScreenPsycoState extends State<otpScreenPsyco> {
                      ...
                      validator: (value) {
                        if (value == widget.otpNum.toString()) {
                          ...
                          Navigator.pushReplacement(
                              context,
                              MaterialPageRoute(
                                builder: (context) => ResetPasswordScreenPsyco(
