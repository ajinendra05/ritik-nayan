...
class ResetPasswordScreenPsyco extends StatefulWidget {
  final otpNum;
  final email;
  const ResetPasswordScreenPsyco(
      {super.key, required this.otpNum, required this.email});
  @override
  State<ResetPasswordScreenPsyco> createState() => _ResetPasswordScreenPState();
}

class _ResetPasswordScreenPState extends State<ResetPasswordScreenPsyco> {
  ...
  Future<void> resetPassword() async {
    ...
    var response = await http.post(
      Uri.parse(resetPasswordPsycoApi),
